...
// }
//
// class CommerceScreen0 extends StatelessWidget {
//   final String? userId;
//
//   const CommerceScreen0({super.key, this.userId});
//
//   @override
...
//                     const SizedBox(height: 12),
//                     Text(l10n.noProductsMatch, textAlign: TextAlign.center),
//                     const SizedBox(height: 12),
//                     OutlinedButton(
//                       onPressed: () => setState(() {
...
//       ScaffoldMessenger.of(
//         context,
//       ).showSnackBar(SnackBar(content: Text(l10n.formErrors)));
//       return;
//     }
...
//     }
//     final list = statuses.toList()..sort((a, b) => a.name.compareTo(b.name));
//     return list;
//   }
//
...
//           children: [
//             Text(
//               l10n.orderConfirmedStep,
//               style: _stepStyle(context, step >= 0),
//             ),
